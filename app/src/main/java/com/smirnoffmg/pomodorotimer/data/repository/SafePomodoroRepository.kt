...
@Singleton
class SafePomodoroRepository @Inject constructor(
    ...
    suspend fun getDailyStatisticsSafe(date: Long): Result<DailyStatistics> {
        return safeSuspendDbCall { repository.getDailyStatistics(date) }
    }
    
    suspend fun getWeeklyStatisticsSafe(weekStart: Long, weekEnd: Long): Result<WeeklyStatistics> {
    ...
    suspend fun getMonthlyStatisticsSafe(monthStart: Long, monthEnd: Long): Result<MonthlyStatistics> {
    ...
    suspend fun getTotalCompletedSessionsCountSafe(fromDate: Long): Result<Int> {
        return safeSuspendDbCall { repository.getTotalCompletedSessionsCount(fromDate) }
    }
    ...
    suspend fun deleteAllSessionsSafe(): Result<Unit> {
        return safeSuspendDbCall { repository.deleteAllSessions() }
    }
